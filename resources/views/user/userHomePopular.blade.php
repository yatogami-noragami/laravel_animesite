...
@section('title', 'Homepage Popular')
    ...
    <section>
        <div class="row mb-3">
            <div class="d-flex offset-1">
                <a href="{{ route('user#popular#name#sort') }}" class=" text-decoration-none">
                    <button class=" btn btn-warning ms-1">sort by name</button>
                </a>

                <a href="#!" class=" text-decoration-none" id="populargenrebtn">
        ...
        <div class="row my-3" id="populargenre">
            @if ($genres)
                <div class="col-lg-8 offset-lg-2 d-flex flex-wrap">
                    @foreach ($genres as $genre)
                        <a href="{{ route('user#popular#genre#sort', $genre->name) }}"
