    ...
    <section>
        ...
        <div class="row mb-3">
            <div class="d-flex offset-1">
                <a href="{{ route('user#movies#name#sort') }}" class=" text-decoration-none">
                    <button class=" btn btn-warning ms-1">sort by name</button>
                </a>

                <a href="#!" class=" text-decoration-none" id="moviesgenrebtn">
        ...
        <div class="row my-3" id="moviesgenre">
            @if ($genres)
                <div class="col-lg-8 offset-lg-2 d-flex flex-wrap">
                    @foreach ($genres as $genre)
                        <a href="{{ route('user#movies#genre#sort', $genre->name) }}"
                    ...
                    <div class="row p-4">
                        @foreach ($animes as $anime)
                            <div class="col-lg-3 col-md-4 col-6 ">
                                <a href="{{ route('user#movie#details', $anime->id) }}" class=" text-decoration-none">
